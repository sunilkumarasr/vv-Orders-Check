...
import com.villagevegetables.orders.Adapters.NewOrders.NewOrdersListAdapter
import com.villagevegetables.orders.Adapters.Pending.PendingOrdersListAdapter
...
import com.villagevegetables.orders.databinding.FragmentAllOrdersBinding
import com.villagevegetables.orders.databinding.FragmentNewOrdersBinding
...
class NewOrdersFragment : Fragment() {
    ...
    private fun getOrdersListApi() {
        ...
        val call = apiServices.getOrdersListApi(getString(R.string.api_key),"1",stateDate,endDate)
    ...
    private fun dataSet(selectedOrdersList: List<OrderHistoryResponse>) {
        binding.recyclerview.apply {
            ...
            binding.recyclerview.adapter  = NewOrdersListAdapter(requireActivity(), selectedOrdersList) { item ->
                val intent = Intent(requireActivity(), OrderDetailsActivity::class.java).apply {
                    putExtra("orderType", "Order Placed")
